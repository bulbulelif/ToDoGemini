...
def create_token_access(username: str, user_id: int, role: str, expires_delta: timedelta):
...
async def login_for_access_token(form_data: Annotated[OAuth2PasswordRequestForm, Depends()], db: db_dependency):
    ...
    token = create_token_access(user.username, user.id, user.role, timedelta(minutes=60))
