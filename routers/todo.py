...
async def render_todo_page(request: Request, todo_id:int, db: db_dependency):
    try:
        ...
        return templates.TemplateResponse("edit- todo.html", {"request": request, "todos": todo, "user":user})
    except:
        return redirect_to_login()
...
def create_todo_with_gemini(todo_string:str):
    ...
    response=llm.invoke(
        [
            HumanMessage(content="I will provide you a todo item to add my to do list. What I want you to do is create a longer and more comprehensive description of that todo item, my next message will be my todo:"),
